...
<html>
    ...
    <body class="w3-light-grey">
        ...
        <div class="w3-content" style="max-width:1100px;">
            ...
            <div class="w3-panel">
                <h1> Update Grade 1 Staff Member </h1>
            </div>
            ...
            <div class="w3-container">
                <div class="w3-padding-16 w3-black w3-card w3-round-large">
                    <div class="w3-panel">
                        ...
                        <form action="./AdUpdateG1Stf" method="post">
                            <p>  
                            ...
                            <p> 
                                <input type="text" class="w3-input w3-padding-16" name="work" placeholder="Working Experience - if any" value="">
